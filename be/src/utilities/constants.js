...
export const dataLink = [
  ...
  // },
  {
    id: 'tổng_kết_công_tác_tuyển_chọn_nam_sinh_tốt_nghiệp_đại_học_đi_đào_tạo_sĩ_quan_dự_bị',
    title: 'Tổng kết công tác tuyển chọn nam sinh tốt nghiệp đại học đi đào tạo sĩ quan dự bị',
    url: 'https://moet.gov.vn/giaoducquocdan/giao-duc-quoc-phong-an-ninh/Pages/default.aspx?ItemID=9342'
  }
]